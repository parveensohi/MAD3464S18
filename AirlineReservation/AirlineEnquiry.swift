...
class AirlinesEnquiry: Airlines{
    ...
    required init(enquiryID : Int, enquirytype : String, enquirytitle : String, enquirydes : String, enquirydate : String,airlinesID : Int,airlinesDes : String,airlinesType : AirportType){
